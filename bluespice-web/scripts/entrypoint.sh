...
# Replace Vars
BLUESPICE_SKIN_LOWER=$(echo $BLUESPICE_SKIN | awk '{print tolower($0)}')
...
[ -n "$BLUESPICE_SKIN" ] && sed -i "s;##BLUESPICE_SKIN##;$BLUESPICE_SKIN;" $LOCALSETTINGS_TARGET || sed -i "s;##BLUESPICE_SKIN##;BlueSpiceDiscovery;" $LOCALSETTINGS_TARGET
[ -n "$BLUESPICE_SKIN_LOWER" ] && sed -i "s;##BLUESPICE_SKIN_LOWER##;$BLUESPICE_SKIN_LOWER;" $LOCALSETTINGS_TARGET || sed -i "s;##BLUESPICE_SKIN_LOWER##;bluespicediscovery;" $LOCALSETTINGS_TARGET
